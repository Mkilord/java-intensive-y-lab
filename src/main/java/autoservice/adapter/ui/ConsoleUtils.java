...
public class ConsoleUtils {
    ...
    /**
     * Reads an integer from the console, validating it with the provided predicate.
     *
     * @param in the {@link Scanner} for console input
     * @param predicate the predicate to validate the integer
     * @return the validated integer
     */
    public static int readInt(Scanner in, Predicate<Integer> predicate) {
        int value;
        boolean isValid;
        do {
    ...
    /**
     * Reads an integer from the console within a specified range, validating it.
     *
     * @param in the {@link Scanner} for console input
     ...
     */
    public static int readIntOfRange(Scanner in, int start, int end) {
        return readInt(in, n -> {
